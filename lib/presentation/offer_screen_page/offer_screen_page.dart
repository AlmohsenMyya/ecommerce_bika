import '../offer_screen_page/widgets/offerscreen_item_widget.dart';import 'controller/offer_screen_controller.dart';import 'models/offer_screen_model.dart';import 'models/offerscreen_item_model.dart';import 'package:dhiwise_ecommerce/core/app_export.dart';import 'package:dhiwise_ecommerce/widgets/app_bar/appbar_title.dart';import 'package:dhiwise_ecommerce/widgets/app_bar/appbar_trailing_image.dart';import 'package:dhiwise_ecommerce/widgets/app_bar/custom_app_bar.dart';import 'package:flutter/material.dart';
// ignore_for_file: must_be_immutable
class OfferScreenPage extends StatelessWidget {OfferScreenPage({Key? key}) : super(key: key);

OfferScreenController controller = Get.put(OfferScreenController(OfferScreenModel().obs));
...
/// Section Widget
Widget _buildOfferScreen() { return Obx(() => ListView.separated(physics: NeverScrollableScrollPhysics(), shrinkWrap: true, separatorBuilder: (context, index) {return SizedBox(height: 16.v);}, itemCount: controller.offerScreenModelObj.value.offerscreenItemList.value.length, itemBuilder: (context, index) {OfferscreenItemModel model = controller.offerScreenModelObj.value.offerscreenItemList.value[index]; return OfferscreenItemWidget(model);})); } 
