    ...
    return Padding(
        ...
        child: Obx(() => ListView.separated(
            ...
            itemCount: controller
                .creditCardAndDebitModelObj.value.cardsItemList.value.length,
            itemBuilder: (context, index) {
              CardsItemModel model = controller
                  .creditCardAndDebitModelObj.value.cardsItemList.value[index];
              return CardsItemWidget(model, onTapCreditCardItem: () {
                onTapCreditCardItem();
              });
            })));
  }
